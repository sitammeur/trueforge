    ...
    return [
      defineTool({
        ...
        description: [
          ...
          '- If a stated preference, existing config, or earlier decision favors one option, put it first with the exact suffix " (Recommended)" — no other wording. Otherwise mark nothing; never recommend from general knowledge.',
          '',
          ...
          '',
          'Example (user already stated a preference for A):',
          'question: "<your question>"',
